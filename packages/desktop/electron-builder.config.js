...
export default {
  ...
  extraMetadata: {
    ...
    homepage: "https://github.com/BlueSkyXN/OpenZWork",
    author: {
      name: "BlueSkyXN",
      email: "blueskyxn@users.noreply.github.com",
    },
  },
  ...
  protocols: [
    {
      ...
      // 展示名跟随安装包身份；scheme 为 openzwork，与官方版互不抢占默认 handler。
  ...
  linux: {
    ...
    maintainer: "BlueSkyXN <blueskyxn@users.noreply.github.com>",
  },
  deb: {

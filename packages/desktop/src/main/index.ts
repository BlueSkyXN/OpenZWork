...
import { DEFAULT_LOCALE, DEFAULT_ZCODE_ENDPOINT_ORIGIN, HostMessageTypes, OPENZWORK_DATA_DIR_NAME, PlatformChannels, ZCODE_ARMS_RUM_ENDPOINT, ZCODE_ENV, ZCODE_PRODUCT_FLAVOR, ZCODE_TELEMETRY_ENABLED, ZCODE_VERSION, desktopMenuMessageIds, resolveZCodeEndpointOrigin, shouldEnableE2ETestBridge, type AppSettings, type Locale, type TelemetryEventPayload, type UpdateStatePayload } from "@zcode/shared";
...
const settingsFile = join(homedir(), OPENZWORK_DATA_DIR_NAME, "v2", "setting.json");

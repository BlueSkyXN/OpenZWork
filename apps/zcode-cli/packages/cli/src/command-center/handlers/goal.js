...
export async function handleTargetCommand(args, deps, options) {
...
async function continueTargetAfterChange(title, target, app, deps, options) {
...
function appendPlanModeGoalContinuationNote(response, mode) {
    return mode === "plan"
...
function formatTargetChanged(title, target) {

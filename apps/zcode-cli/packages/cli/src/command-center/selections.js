...
export function buildSessionSelection(sessions) {
    return {
...
export function buildCheckpointSelection(action, checkpoints) {
...
export function buildTargetReplaceSelection(existing, objective) {
    return {

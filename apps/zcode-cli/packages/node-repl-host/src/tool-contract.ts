...
// 按上面这条规则该动。数字与 browser-use 0.5.0 相同
...
// 也会误选这个高权限工具。Browser Use 是合法入口，因此 server 与 tool 文案都要显式限域。
export const NODE_REPL_SERVER_INSTRUCTIONS =
  ...
  "the corresponding official skill instructs you to control a browser. Do not use this server for unrelated tasks, " +
...
export const JS_TOOL_DESCRIPTION =
  ...
  "instructed by the corresponding official skill to control a browser. Do not use it as a general-purpose JavaScript runtime " +
